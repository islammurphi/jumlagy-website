...
const PRECACHE_URLS = [
    ...
    './app.js',
    './manifest.json',
    // icons/assets may not exist in some deployments; precache will ignore failures
    ...
    event.waitUntil(
        caches.open(CACHE_NAME)
            .then((cache) => {
                ...
                // cache.addAll fails the whole install if any URL fails.
                // We prefetch individually to keep the app installable even if
