...
function loadDashboard() {
    ...
    if (statsCards) {
        statsCards.innerHTML = `
            ...
            <div class="stat-card"><div class="stat-card-icon icon-cyan"><i class="fas fa-shopping-cart"></i></div><p class="stat-card-title">متوسط قيمة الطلب</p><p class="stat-card-value">${formatCurrency(avgOrderValue)}</p></div>
            <div class="stat-card"><div class="stat-card-icon icon-teal"><i class="fas fa-check-double"></i></div><p class="stat-card-title">معدل الإتمام</p><p class="stat-card-value">${completionRate}%</p></div>
        `;
    }
